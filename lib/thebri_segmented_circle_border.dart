...
class TheBrioSegmentedCircleBorder extends ShapeBorder {
  /// Creates a segmented circle border.
  ///
  /// Length of [sides] must be less than [numberOfSegments].
  // ignore: non_constant_identifier_names
  TheBrioSegmentedCircleBorder(
      {this.offset = 0.0, this.numberOfSegments, this.sides}) {
  ...
  @override
  ShapeBorder scale(double t) => TheBrioSegmentedCircleBorder(
      offset: offset,
